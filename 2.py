...
a = []
b= 'E:\programming\PyLearn-SajjadAemmi\Assignment6\AliStore\database.txt'
c = 'E:\programming\PyLearn-SajjadAemmi\Assignment6\AliStore\qrcode.png'
...
def e():
    ...
    print(f.renderText("roozbeh store"))
